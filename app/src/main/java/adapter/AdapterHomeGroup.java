...
public class AdapterHomeGroup extends RecyclerView.Adapter<AdapterHomeGroup.ViewHolder> {
    Context context;
    List<String> list;
    public AdapterHomeGroup(Context context, List<String> list)
    {
    ...
    //1. Khoi tao layout
    @Override
    public AdapterHomeGroup.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        //Khoi tao layout
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        if (viewType ==0){
            View view = inflater.inflate(R.layout.custom_recycleview_home,parent,false);
            AdapterHomeGroup.ViewHolder viewHolder = new AdapterHomeGroup.ViewHolder(view);
    ...
    @Override
    public void onBindViewHolder(final AdapterHomeGroup.ViewHolder holder, final int position) {
