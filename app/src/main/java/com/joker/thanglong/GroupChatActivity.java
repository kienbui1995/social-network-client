...
public class GroupChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        uId = GroupActivity.groupInfo.getId();
        ...
        mdatabase.child("conversation").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                idRoom = GroupActivity.groupInfo.getId()+"";
                setupChat();
            }
                        ...
                        try {
                            ...
                            firebaseHelper.UploadFile("/images/chat/"+SystemHelper.getTimeStamp(), bmp, new FirebaseHelper.FirebaseCallback() {
                                ...
                                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                    ...
                                    Toast.makeText(GroupChatActivity.this, "Tải ảnh lên thành công", Toast.LENGTH_SHORT).show();
                                }
                            });
                        } catch (IOException e) {
                            e.printStackTrace();
            ...
            protected void populateViewHolder(RecyclerView.ViewHolder viewHolder, final ChatItem model, int position) {
                ...
                }else if (model.getId() == myId && model.getPhoto() != "")
                {
                    ...
                    viewHolderPhotoMe.imgContentChat.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            DialogUtil.showImageEnlarge(GroupChatActivity.this,model.getPhoto());
                        }
                    });
                    return;
                    ...
                    userModel.realmUser(getApplicationContext(), model.getId(), new UserModel.VolleyCallBackProfileUser() {
                        @Override
                        public void onSuccess(EntityUserProfile profile) {
                            Glide.with(getApplicationContext()).load(profile.getAvatar())
                ...
                {
                    Log.d("fr","photo");
                    final ViewHolderPhotoFriend viewHolderPhotoFriend = (ViewHolderPhotoFriend) viewHolder;
...
//        mdatabase.child("user").child(uId+"").child("conversation").child(idRoom).setValue(conversation1);
        mdatabase.child("group").child("conversation").child(idRoom).setValue(conversation);
    ...
    private void setupTabs() {
        toolbarNotification.setTitle(GroupActivity.groupInfo.getName());
